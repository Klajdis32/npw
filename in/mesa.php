...
<body>
    ...
    <div id="neoproject">
        <form method="post" action="/NewPersonalWebsite/project/send-project.php" enctype="multipart/form-data" onsubmit="return validateForm();">
            <img src="/NewPersonalWebsite/images/back.png" alt="" class="mode" id="back1">
            <br>
            <p class="epi">Νέο Project:</p>
            <p class="minima">Τίτλος:</p>
            <input type="text" id="titlos" name="titlos" placeholder="Τίτλος του Project" autocomplete="titlos"><br>

            <p class="minima">Συγγραφέας:</p>
            <input type="text" id="sigrafeas" name="sigrafeas" placeholder="Συγγραφέας του Project" autocomplete="sigrafeas"><br>
